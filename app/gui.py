...
def make_gui(theme):
    ...
    input_layout = [[sg.Text('')]]
    input_layout += market_layout + broker_layout + trader_layout
    input_layout += [[sg.ProgressBar(1000, orientation='h', size=(20, 20), key='-PROGRESS BAR-')]]
    input_layout += [[sg.Button('Go'), sg.Button('Stop'), sg.Button('Help'), sg.Button('Exit')]]

    logging_layout = [[sg.Text("Logger:")], [sg.Output(size=(80, 80), font='Courier 8')]]

    graphing_layout = [[sg.Text("Results:")],
    ...
    layout = [[sg.Text('BackTesting Trading Simulation Application', size=(38, 1), justification='center',
                       font=("Helvetica", 16),
